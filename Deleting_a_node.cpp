...
This will effectively skip the last node of the list therefore, we will free up the memory being occupied by this node (Only in the case of C++).
...
Algorithm:
Start by initializing a pointer to the head of the list that will be used to iterate through the linked list. 
Iterate up to the second last node, this node will be our new tail of the list.
